...
- gganimate:
  ...
  [`enter_fade()`](https://gganimate.com/reference/enter_exit.html),
  [`enter_grow()`](https://gganimate.com/reference/enter_exit.html),
  [`exit_fade()`](https://gganimate.com/reference/enter_exit.html),
